...
In addition there was a Catholic church and a synagogue.  As you might imagine, after five years of Nazi rule, there were no Jews listed in the 1944 census.

```{r}
schowe_residents_1944 %>% count(faith)
```
